...
//		quickSort(array, 0, array.length); 
	...
	/**
	 * Shell Sort: T: worst case: O(n^2)- average O(n log(n))
	 * @param array
	 * @return Integer[] array
	 */
	...
	/**
	 * find the location of pivot element in quick sort
	 * @param array
	 * @param start
	 * @param end
	 * @return
